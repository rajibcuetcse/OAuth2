    ...
    <div class="col-md-12">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Add User Balance</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
                                                        <?= $this->Form->create($bizUserBalance,['class' => 'form-horizontal']) ?>
                                                        <?php 
                                                        $myTemplates = [
                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <div class="form-group">
                            ...
                            <?php echo $this->Form->input('biz_user_id',['options' => $bizUsers,'class' =>'form-control','label' => false]);?>        
                        </div>
                        <div class="form-group">
